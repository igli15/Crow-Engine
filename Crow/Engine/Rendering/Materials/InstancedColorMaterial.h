...
#ifndef CROW_INSTANCEDCOLORMATERIAL_H
#define CROW_INSTANCEDCOLORMATERIAL_H

#include "../AbstractMaterial.h"

class InstancedColorMaterial : public AbstractMaterial {
...
public:
    ...
    void RenderInstanced(Model* meshRenderer,int amountOfInstances, const glm::mat4& pViewMatrix, const glm::mat4& pPerspectiveMatrix,const glm::vec3& viewPos,World* world) override;
    void Initialize();
...
#endif //CROW_INSTANCEDCOLORMATERIAL_H
