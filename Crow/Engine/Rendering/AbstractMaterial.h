...
public:
    ...
    virtual void RenderInstanced(Model* meshRenderer,int amountOfInstances, const glm::mat4& pViewMatrix, const glm::mat4& pPerspectiveMatrix,const glm::vec3& viewPos,World* world){}
